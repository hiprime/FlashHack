...
class Themify {
	...
	function template_redirect() {
		...
		elseif($this->post_layout == 'timeline'):

			$this->width = self::$timeline_post_width;
		...
		if( is_page() ) {
			...
			$this->width = '' != $post_image_width? $post_image_width: $this->width;
			$this->height = '' != $post_image_height? $post_image_height: $this->height;
			...
			if( 'timeline' == $this->post_layout ) {
				...
				$this->width = '' != $post_image_width? $post_image_width: $timeline_default_width;
				$this->height = '' != $post_image_height? $post_image_height: $timeline_default_height;
