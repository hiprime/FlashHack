...
if (!class_exists('Cooltimeline_Styles')) {
    ...
    class Cooltimeline_Styles {
        ...
        public function clt_v_story_styles($post_id){

            $ctl_story_color = get_post_meta($post_id, 'ctl_story_color', true);
            $styles='';
           if(isset($ctl_story_color) && !empty(trim($ctl_story_color))&& $ctl_story_color!="#"){
        $styles='
		...
		{border-right:transparent;}
				...
				';  
             return $this->clt_minify_css($styles); 
             }       
        }

        public function ctl_h_story_styles($post_id){
          $ctl_story_color = get_post_meta($post_id, 'ctl_story_color', true);
              $styles='';
           if(isset($ctl_story_color) && !empty(trim($ctl_story_color))&& $ctl_story_color!="#"){
              $styles='
...
$styles.=' .cool-timeline .light-grey-post .timeline-content:after,
 ...
 $styles.='      ';
         ...
         wp_add_inline_style( 'ctl_styles',$this->clt_minify_css($styles));
         wp_add_inline_style( 'ctl-styles-horizontal',$this->clt_minify_css($styles_hori));
       ...
       function ctl_navigation_styles() {
        ...
        public function clt_minify_css($css){
         $buffer = $css;
          // Remove comments
